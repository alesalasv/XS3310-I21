...
# Detalles del proyecto de Bayes

**Tema:** Diferencias entre la inferencia clásica y la Bayesiana (ventajas y desventajas de cada una)

* Opciones de formato:

  - App de Shiny (nuevo o arreglar versiones betas): https://andreavargasmontero.github.io/apps_shiny_bayes/ Si quieren mejorar versiones Beta, pueden solicitarle el código a Andrea.
  - Vídeo 5 minutos (que incluya a todos los miembros del grupo) con la explicación, editado y listo para subirlo a YouTube.

* Dinámica: Uds hacen los grupos de 6 o 7 personas, de acuerdo a su preferencia, y eligen una persona coordinadora del grupo, deben especificar su grupo aquí:

https://docs.google.com/spreadsheets/d/152uhams6SDZ6xYrGyzOCW1t8724JP4eyVI-xgN3wpN8/edit?usp=sharing

---
class: middle, inverse

* Si prefieren trabajar con grupos más pequeños o individualmente, serán responsables de llevar a cabo el proyecto de manera individual, pero con las mismas exigencias de un trabajo grupal. La propuesta del trabajo (con un plan concreto de cómo llevarlo a cabo, y con los miembros del grupo confirmados) será entregada el 3 de julio y tendrá un valor de 3%. El proyecto terminado se entrega a más tardar el 14 de julio, por medio de un link al app de shiny, al vídeo en YouTube o al ensayo.

**Propuesta:** Máximo 1 página con los siguientes elementos:
Miembros del grupo, con nombre completo y carné, y con la persona coordinadora con un *
Elección del formato (App de Shiny o Vídeo)
Plan para realizarlo (objetivos, herramientas disponibles, en el caso de vídeo un guión, en el caso del App de Shiny un dibujo con el diseño final).

**Calificación:**

* Originalidad y claridad 2 pt
* Línea lógica 2 pt
* Uso de referencias, supuestos y no solo opiniones 2 pts
* Uso correcto de conceptos de estadística clásica y Bayesiana 4 pts

---

## Un poco de historia

![http://www.statslife.org.uk/images/pdf/timeline-of-statistics.pdf](timeline.png)
...
* Un tiempo después, Gelfand y Smith (1990) propusieron la forma de encontrar numéricamente distribuciones marginales, y a apartir de esto la estadística Bayesiana se convirtió en una herramienta de uso común entre todas las personas que practican la estadística.
...
![FisherBayes.png](Fisher_Bayes.png)
