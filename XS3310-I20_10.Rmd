...
Suponga que tienen datos te tiempos de espera en minutos en un banco con $n=25$ clientes. La distribución del tiempo se observa que sigue una distribución $Poisson(\theta)$ con $\bar{X} = 5$. Cual es el intervalo de confianza para $\theta$ a un 95%.
...
$$\begin{align*}& \left[5-1.645\left(\frac{\sqrt{5}}{5}\right), 5-1.645\left(\frac{\sqrt{5}}{5}\right)  \right]   \\&= \left[ 4.26, 5.73\right]\end{align*}$$
---
