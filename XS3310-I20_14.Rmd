...
Suponga que se tiene una prueba de hipotesis y se encuentra la región crítica (o región de rechazo) \(RC_\delta\) de un contraste \(\delta\) sobre \(\theta\) con nivel \(\alpha\). 

Entonces un intervalo de confianza con nivel \(\alpha\) de este parametro, esta dado por \(RC_\delta^c\).
