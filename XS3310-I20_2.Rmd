...
¿Por qué? porque aplicando el teorema 1.1 sabemos que $\frac{(\bar{X}_n-\mu)}{\sigma/\sqrt{n}}$ se distribuye como una normal estándar. 

¿De dónde viene la variable $Z$? 

Es como se define una v.a. distribuida como $N(0,1)$ y se llama Z, estos valores de Z corresponden al área debajo de la curva de densidad en una curva normal $N(0,1)$. Existe una tabla con valores precalculados alresolver la integral:
$$\Phi(z) = \int^{z}_{-\infty}\frac{1}{\sqrt{2\pi}}\ e^{-\frac{t^2}{2} } \ dt,$$

o simplemente usando un R:
