...
Entregar la propuesta del proyecto de Bayes hoy (espacio en Mediación, uno por grupo), luego el quiz del martes 10 de julio (4to trabajo) y finalmente el proyecto de Bayes. El espacio para enviar el link del proyecto final está en Mediación Virtual.
