...
Ya sabemos que $\hat{\theta}_{1}$ y $\hat{\theta}_{2}$ son estimadores insesgados de $\theta$, por lo que se cumple la primera condición del Teorema 3.1; solo nos hace falta demostrar la segunda propiedad:
...
$f(x_{1}, ... , x_{n} | U = u) = \dfrac{\theta^{-n}}{\dfrac{nu^{n-1}}{\theta^n}} = \dfrac{1}{nu^{n-1}}$
...
Tienen 30 minutos para resolver los dos ejercicios. Cuando terminen, pueden volver a la sesión principal para revisar sus respuestas.
